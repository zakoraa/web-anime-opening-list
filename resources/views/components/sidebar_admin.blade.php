    ...
    <div class="h-full w-1/5 bg-gray-900 text-gray-100">
        ...
        <nav class="mt-6">
            <ul>
                ...
                <li class="mb-4">
                    <a href="#" class="group flex items-center text-gray-300 hover:text-white py-2 px-4 relative">
                        <svg class="me-3" style="color: white" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-play-btn-fill" viewBox="0 0 16 16">
