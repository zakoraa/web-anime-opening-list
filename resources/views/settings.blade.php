...
@section('content')
<h1 class="text-white text-center my-10 text-5xl font-extrabold flex justify-center items-center">Settings<span>
        <svg class="ms-3" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50">
